package com.example.quizmee.SpinWheel;
...
import com.example.quizmee.R;
import com.example.quizmee.SpinWheel.model.LuckyItem;
...
public class LuckyWheelView extends RelativeLayout implements PielView.PieRotateListener {
     ...
     * @param data
     */
    public void setData(List<LuckyItem> data) { pielView.setData(data);
    }
